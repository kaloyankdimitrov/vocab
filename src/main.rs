...
async fn fetch_all(word: &str) -> (String, String, String, String, String, String) {
	let urls: [&str; 6] = [
		&format!("https://www.macmillandictionary.com/dictionary/british/{}", word)[..],
		&format!("https://www.macmillandictionary.com/dictionary/american/{}", word)[..],
	...
	(r1.unwrap(), r2.unwrap(), r3.unwrap(), r4.unwrap(), r5.unwrap(), r6.unwrap())
}

#[tokio::main]
async fn main() {
	let word = args().nth(1).expect("No word given!");
	let (t1, t2, t3, t4, t5, t6) = fetch_all(&word).await;	
